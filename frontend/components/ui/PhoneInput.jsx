            ...
            <div className="flex">
                ...
                <div className="relative">
                    <button
                        ...
                        className="flex items-center gap-1 px-3 py-2 bg-gray-50 dark:bg-gray-800/50 border-2 border-r-0 border-gray-200 dark:border-gray-700 rounded-l-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors h-full"
                    >
