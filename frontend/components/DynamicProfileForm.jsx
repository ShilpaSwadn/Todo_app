                    ...
                    {field.type === 'select' ? (
                      <div className="relative">
                        <button
                          ...
                          className={`w-full px-7 py-5 border rounded-[1.75rem] transition-all text-sm font-bold flex items-center justify-between group/sel ${
                            isReadOnly 
                      ...
                      <input
                        ...
                        min={field.min}
                        className={`w-full px-7 py-5 border rounded-[1.75rem] transition-all text-sm font-bold ${
                          isReadOnly 
                          ? 'bg-gray-50 dark:bg-gray-900/50 border-gray-100 dark:border-gray-800 text-gray-400 dark:text-gray-500 cursor-not-allowed' 
